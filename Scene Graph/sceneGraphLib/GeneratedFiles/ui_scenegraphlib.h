...
public:
    ...
    void setupUi(QMainWindow *sceneGraphLibClass)
    {
        ...
        sceneGraphLibClass->resize(982, 802);
        ...
        widget->setGeometry(QRect(250, 10, 721, 491));
...
"}"));
        ...
        pushButton->setGeometry(QRect(790, 660, 91, 31));
        pushButton_2 = new QPushButton(centralWidget);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(690, 660, 91, 31));
        tableWidget = new MyFrameWidget(centralWidget);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));
        tableWidget->setGeometry(QRect(250, 530, 721, 121));
        tableWidget->setStyleSheet(QString::fromUtf8(""));
        scaleLabel_2 = new QLabel(centralWidget);
        scaleLabel_2->setObjectName(QString::fromUtf8("scaleLabel_2"));
        scaleLabel_2->setGeometry(QRect(260, 499, 131, 31));
        ...
        checkBox->setGeometry(QRect(890, 660, 81, 31));
        ...
        line_11->setGeometry(QRect(250, 680, 721, 51));
    ...
    void retranslateUi(QMainWindow *sceneGraphLibClass)
    {
        ...
        actionCIS277_HW3->setText(QApplication::translate("sceneGraphLibClass", "CIS277 - HW3", 0, QApplication::UnicodeUTF8));
        actionHello_Puppet_v1_0->setText(QApplication::translate("sceneGraphLibClass", "Hello Puppet v1.0", 0, QApplication::UnicodeUTF8));
        ...
        scaleLabel_2->setText(QApplication::translate("sceneGraphLibClass", "Key Frame Animation Editor", 0, QApplication::UnicodeUTF8));
